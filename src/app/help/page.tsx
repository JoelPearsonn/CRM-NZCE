  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <div className="grid gap-5">
        ...
        <Guide
          title="Staff lock"
          body="The pages can stay on screen, but exports, imports, recordings, LOA files and writes stay locked until you sign in at /login with your own @nzcenergy.co.uk work email and password. There is no shared code and no Google or Clerk login. If your password has not been set, ask Joel. Do not put the CRM on a public URL."
        >
