  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-muted">
        Same columns as Export deals. Full deal value is already net of TPI — Payment 1 / 2 / 3 split
        that pot (TPI partner is stored, not deducted again). Zeros in the split stay in place
        (0/80/20 is On Live + EOC). Expected dates are stored when those columns are present.
        Actual commission is one received pair for the deal. Existing contracts are matched by
